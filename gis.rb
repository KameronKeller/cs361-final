...
class Point
  ...
  attr_reader :lat, :longitude, :elevation

  def initialize(longitude, lat, elevation=nil)
    @longitude = longitude
    @lat = lat
    @elevation = elevation
  end
...
class Waypoint
  ...
  attr_reader :lat, :longitude, :elevation, :name, :type

  def initialize(longitude, lat, elevation=nil, name=nil, type=nil)
    @longitude = longitude
    @lat = lat
    @elevation = elevation
    @name = name
